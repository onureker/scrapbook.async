...
namespace SynchronizationContextDeep.Custom2
{
    internal class SendOrPostCallbackItem
    {
        ...
        internal Exception Exception => mException;

        internal bool ExecutedWithException => mException != null;
        ...
        internal WaitHandle ExecutionCompleteWaitHandle => mAsyncWaitHandle;
    }
}
